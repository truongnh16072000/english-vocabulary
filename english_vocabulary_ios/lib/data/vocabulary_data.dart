class VocabularyData {
  static const String a2Raw = r'''ability|[ə'bıləti]|n|khả năng|F|He has great ability|Anh ấy có khả năng tuyệt vời
...
const callGeminiAPI = async (prompt) => {
  ...
  static const String b1Raw = r'''absolutely|/'æbsə,lu:tli/|adv|hoàn toàn|G|She is absolutely certain.|Cô ấy hoàn toàn chắc chắn.|completely, totally|absolutely necessary, absolutely right
